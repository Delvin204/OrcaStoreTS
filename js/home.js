...
export const showTopSell = async () => {
    let products = await fetch("http://localhost:3000/topSeller")
        .then(res => res.json())
        .then(data => { return data; });
    let str = ``;
...
export const showMostPlay = async () => {
    let products = await fetch("http://localhost:3000/mostPlayed")
        .then(res => res.json())
        .then(data => { return data; });
    let str = ``;
...
export const showTopRate = async () => {
    let products = await fetch("http://localhost:3000/topRating")
        .then(res => res.json())
        .then(data => { return data; });
    let str = ``;
